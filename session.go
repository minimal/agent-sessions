...
type Session struct {
	...
	Background bool         // true if Live and running detached (claude --background), no pane to jump to
	JobID      string       // short id `claude attach`/`claude stop` takes; set when Background
